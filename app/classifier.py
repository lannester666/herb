...
train_root='F:\\swlab\\智药\\hxy/train8/train/'
vaildation_root='F:\\swlab\\智药\\hxy/train8/valid/'
test_root='F:\\swlab\\智药/hxy/train8/test/'
...
if __name__=='__main__':
    ...
    if os.path.exists('inception_1.h5'):
        ...
        model=check_print()
        model.fit_generator(train_generator,validation_data=vaild_generator,epochs=EPOCH,steps_per_epoch=train_generator.n/batch_size ,validation_steps=vaild_generator.n/batch_size)
